// ======================================================================
// Design01_Copy_01.v generated from TopDesign.cysch
// 05/27/2020 at 11:53
...
module Scan_ADC_v3_10_0 (
    ...
    defparam SARMUX.input_mode = "01";
    defparam SARMUX.muxin_width = 2;


	cy_clock_v1_0
		#(.id("6290514b-d01d-4135-b44a-9cdbf6ac6db1/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module SCB_UART_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("5bc271b5-08fe-4351-8415-a6433f316c0e/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
module SCB_I2C_PDL_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("066ba481-9f8c-47e3-b49f-9c6dd3a73958/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("066ba481-9f8c-47e3-b49f-9c6dd3a73958/69c3b5e8-b094-4d65-b96b-9f4f3a9a8641"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("066ba481-9f8c-47e3-b49f-9c6dd3a73958/2aab8a93-e7dd-4bd4-8210-42652cd079c5"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
...
// RTC_PDL_v2_0(DateFormat=0, DaylightSavingsTimeEn=false, DayOfMonth=27, DayOfMonthDstStart=22, DayOfMonthDstStop=22, DayOfWeek=4, DayOfWeekDstStart=1, DayOfWeekDstStop=1, DstDateType=0, EnableRtcInterrupt=true, Hour=11, HoursDstStart=0, HoursDstStop=0, Month=5, MonthDstStart=3, MonthDstStop=10, RemoveIntr=false, TimeFormat=0, TimeResetOnStart=false, WeekOfMonthDstStart=6, WeekOfMonthDstStop=6, Year=20, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=RTC_PDL_v2_0, CY_CONFIG_TITLE=RTC_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RTC_1, CY_INSTANCE_SHORT_NAME=RTC_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=rtc, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3 Early Access, INSTANCE_NAME=RTC_1, )
module RTC_PDL_v2_0_3 ;
...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3 Early Access, INSTANCE_NAME=BLE_IncludeBleLibs, )
...
// MCWDT_PDL_v1_10(C0_enable=true, C0ClearOnMatch=1, C0Match=32000, C0Mode=0, C1_enable=true, C1ClearOnMatch=1, C1Match=9, C1Mode=1, C2_enable=false, C2Mode=0, C2Period=16, CascadeC0C1=true, CascadeC1C2=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=MCWDT_PDL_v1_10, CY_CONFIG_TITLE=MCWDT, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=MCWDT, CY_INSTANCE_SHORT_NAME=MCWDT, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=mcwdt, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3 Early Access, INSTANCE_NAME=MCWDT, )
module MCWDT_PDL_v1_10_6 (
    interrupt);
    output      interrupt;
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("cef3f63d-3422-42f3-b337-1d5c8367dafb"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("d6e793a7-a33c-4c89-a57a-73b6dccf449d"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("4261abec-23b4-4fdf-9113-e7ecc5ae1c35"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
	...
	wire [0:0] tmpFB_0__MAX30102_enable_net;
	wire [0:0] tmpIO_0__MAX30102_enable_net;
	electrical [0:0] tmpSIOVREF__MAX30102_enable_net;

	cy_mxs40_gpio_v1_0
		#(.id("1d6c75fd-f039-4bf5-938b-b138a5dfc5ae"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		MAX30102_enable
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__MAX30102_enable_net[0:0]}),
		  .io({tmpIO_0__MAX30102_enable_net[0:0]}),
		  .siovref(tmpSIOVREF__MAX30102_enable_net));


	wire [0:0] tmpFB_0__MAX30102_int_net;
	wire [0:0] tmpIO_0__MAX30102_int_net;
	electrical [0:0] tmpSIOVREF__MAX30102_int_net;

	cy_mxs40_gpio_v1_0
		#(.id("adc65b0e-30ee-4754-880c-beb3ccc9e27c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("1"),
		...
		MAX30102_int
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__MAX30102_int_net[0:0]}),
		  .io({tmpIO_0__MAX30102_int_net[0:0]}),
		  .siovref(tmpSIOVREF__MAX30102_int_net));


	wire [0:0] tmpIO_0__Charge_status_net;
	electrical [0:0] tmpSIOVREF__Charge_status_net;

	cy_mxs40_gpio_v1_0
		#(.id("dd205809-e6ee-4d07-8f1b-d52a28d647d7"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
	...
	wire [0:0] tmpFB_0__Charge_led_net;
	wire [0:0] tmpIO_0__Charge_led_net;
	electrical [0:0] tmpSIOVREF__Charge_led_net;

	cy_mxs40_gpio_v1_0
		#(.id("44e8ddf9-2656-4676-bc54-ed038d8542c2"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Charge_led
		 (.oe({1'b1}),
		  .y({Net_174}),
		  .fb({tmpFB_0__Charge_led_net[0:0]}),
		  .io({tmpIO_0__Charge_led_net[0:0]}),
		  .siovref(tmpSIOVREF__Charge_led_net));


	wire [0:0] tmpFB_0__Work_led_net;
	wire [0:0] tmpIO_0__Work_led_net;
	electrical [0:0] tmpSIOVREF__Work_led_net;

	cy_mxs40_gpio_v1_0
		#(.id("8e2eeda8-053c-4c87-8873-95d412b21368"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Work_led
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__Work_led_net[0:0]}),
		  .io({tmpIO_0__Work_led_net[0:0]}),
		  .siovref(tmpSIOVREF__Work_led_net));
	...
	cy_mxs40_gpio_v1_0
		#(.id("ed72ab07-7c70-40b1-93e7-b32760a43c6c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
