...
static cy_stc_ble_gapp_adv_params_t cy_ble_gappAdvConfig[0x01u] = {
    ...
    {
        .fastAdvIntervalMin                 = 0x0640u, 
        .fastAdvIntervalMax                 = 0x0650u, 
        .fastAdvTimeOut                     = 0x0000u, 
        .slowAdvEnable                      = 0x00u, 
        .slowAdvIntervalMin                 = 0x0640u, 
        .slowAdvIntervalMax                 = 0x0640u, 
        .slowAdvTimeOut                     = 0x0000u, 
    },
};
...
cy_stc_ble_gapp_disc_param_t cy_ble_discoveryParam[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        0x0640u, /* uint16_t advertising_interval_min */ 
        0x0650u, /* uint16_t advertising_interval_max */ 
...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x0Du, 0x09u, 0xE5u, 0xB0u,
        0x8Fu, 0xE4u, 0xB8u, 0x81u, 0xE5u, 0xAEu, 0xB6u,
        0x30u, 0x30u, 0x32u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x7Eu] = {
    /* Device Name */
    (uint8_t)'å', (uint8_t)'°', (uint8_t)'', (uint8_t)'ä', (uint8_t)'¸', (uint8_t)'', (uint8_t)'å', (uint8_t)'®',
(uint8_t)'¶', (uint8_t)'0', (uint8_t)'0', (uint8_t)'2', 
...
0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 
    ...
    /* Simon testChara Descriptor */
    0x00u, 0x20u, 0x93u, 0xA6u, 0x1Au, 0x71u, 0x45u, 0x7Bu, 0x91u, 0x4Eu, 0x43u, 0x6Eu, 0x88u, 0x3Au, 0x87u, 0xE6u, 0xA5u, 

    /* Simon indicate Charac */
    0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 

    /* Custom Descriptor */
    0x00u, 0x49u, 0x93u, 0x91u, 0x39u, 0x05u, 0xB1u, 0x6Eu, 0xB2u, 0x9Au, 0x49u, 0x50u, 0x0Bu, 0xADu, 0x15u, 0x0Cu, 0x4Fu, 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Simon Service */
    { 0xE3u, 0x51u, 0x93u, 0x7Cu, 0xEAu, 0xE7u, 0xC3u, 0x96u, 0xBAu, 0x40u, 0x5Cu, 0x1Fu, 0xAFu, 0x7Eu, 0x28u, 0x3Bu },
    /* Simon test Characteristic */
    { 0x95u, 0xFAu, 0xACu, 0xB5u, 0x76u, 0xA1u, 0x71u, 0xABu, 0x19u, 0x4Du, 0x9Fu, 0xADu, 0x07u, 0xC3u, 0x78u, 0x88u },
    /* Simon indicate Charac */
    { 0x9Eu, 0x9Fu, 0xF5u, 0x94u, 0xE4u, 0x98u, 0x13u, 0x95u, 0x45u, 0x4Du, 0x88u, 0xBEu, 0xD3u, 0x49u, 0xAEu, 0xE9u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Fu] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[22] }, /* Central Address Resolution */
    { 0x0001u, (void *)&cy_ble_attValues[23] }, /* Resolvable Private Address Only */
    { 0x0004u, (void *)&cy_ble_attValues[24] }, /* Service Changed */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* Simon Service UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* Simon test Characteristic UUID */
    { 0x0020u, (void *)&cy_ble_attValues[28] }, /* Simon test Characteristic */
    { 0x0001u, (void *)&cy_ble_attValues[60] }, /* Simon testChara Descriptor */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* Simon indicate Charac UUID */
    { 0x0020u, (void *)&cy_ble_attValues[77] }, /* Simon indicate Charac */
    { 0x0001u, (void *)&cy_ble_attValues[109] }, /* Custom Descriptor */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x17u] = {
    ...
    { 0x0012u, 0xC307u /* Simon test Characteristic           */, 0x09120001u /* rd,ntf */, 0x0014u, {{0x0020u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x873Au /* Simon testChara Descriptor          */, 0x09000001u /*        */, 0x0013u, {{0x0001u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0x2902u /* Client Characteristic Configuration */, 0x030A0101u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00080001u /* wr     */, 0x0017u, {{0x0010u, (void *)&cy_ble_attValuesLen[12]}} },
    { 0x0016u, 0x49D3u /* Simon indicate Charac               */, 0x09080100u /* wr     */, 0x0017u, {{0x0020u, (void *)&cy_ble_attValuesLen[13]}} },
    { 0x0017u, 0x15ADu /* Custom Descriptor                   */, 0x09000001u /*        */, 0x0017u, {{0x0001u, (void *)&cy_ble_attValuesLen[14]}} },
};
