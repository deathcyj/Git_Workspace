...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x0020u)
 ...
 */
#define CY_BLE_SIMON_SERVICE_SERVICE_INDEX   (0x00u) /* Index of Simon Service service in the cy_ble_customs array */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Simon test Characteristic characteristic */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_SIMON_TESTCHARA_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Simon testChara Descriptor descriptor */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CY_BLE_SIMON_SERVICE_SIMON_INDICATE_CHARAC_CHAR_INDEX   (0x01u) /* Index of Simon indicate Charac characteristic */
#define CY_BLE_SIMON_SERVICE_SIMON_INDICATE_CHARAC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */


#define CY_BLE_SIMON_SERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of Simon Service service */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_DECL_HANDLE   (0x0011u) /* Handle of Simon test Characteristic characteristic declaration */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_CHAR_HANDLE   (0x0012u) /* Handle of Simon test Characteristic characteristic */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_SIMON_TESTCHARA_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Simon testChara Descriptor descriptor */
#define CY_BLE_SIMON_SERVICE_SIMON_TEST_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */
#define CY_BLE_SIMON_SERVICE_SIMON_INDICATE_CHARAC_DECL_HANDLE   (0x0015u) /* Handle of Simon indicate Charac characteristic declaration */
#define CY_BLE_SIMON_SERVICE_SIMON_INDICATE_CHARAC_CHAR_HANDLE   (0x0016u) /* Handle of Simon indicate Charac characteristic */
#define CY_BLE_SIMON_SERVICE_SIMON_INDICATE_CHARAC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0017u) /* Handle of Custom Descriptor descriptor */
