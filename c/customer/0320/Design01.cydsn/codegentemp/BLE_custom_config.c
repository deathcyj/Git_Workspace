...
static const cy_stc_ble_customs_t cy_ble_customs[0x01u] = {
    ...
    /* Simon Service service */
    {
        0x0010u, /* Handle of the Simon Service service */ 
        {

            /* Simon test Characteristic characteristic */
            {
                0x0012u, /* Handle of the Simon test Characteristic characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0013u, /* Handle of the Simon testChara Descriptor descriptor */ 
                    0x0014u, /* Handle of the Client Characteristic Configuration descriptor */ 
                }, 
            },

            /* Simon indicate Charac characteristic */
            {
                0x0016u, /* Handle of the Simon indicate Charac characteristic */ 
